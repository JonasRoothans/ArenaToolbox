classdef BiteAnalysis < handle 
    ...
    methods
        function obj = BiteAnalysis(Map, IndividualProfile, SimilarityMethod)
        ...
        function obj=takebite(obj,SimilarityMethod, Mask); % Mask must be of the VoxelDataClass; like tmap for signedpmap 
            ...
            if nargin<3;
                Mask=0;
                warning(' no mask for map selected, if this is signedpmap, please select');
            end
